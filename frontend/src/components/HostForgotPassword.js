    ...
    <div className="min-h-screen bg-[#fafafa]">
      ...
      >
        <div className="container">
          <h1 className="text-[2.2rem] text-white mb-3">Forgot Password</h1>
        ...
        <div className="container" style={{ maxWidth: 480 }}>
          {submitted ? (
            <div className="bg-white rounded-[12px] p-10 shadow-[0_2px_15px_rgba(0,0,0,0.08)] text-center">
              ...
              <Link href="/host/login" className="inline-block mt-6 text-[#ff6b9d] font-semibold underline text-[0.9rem]">
                Back to login
              </Link>
            </div>
          ) : (
            ...
            >
              ...
              <div className="flex flex-col gap-2 mb-6">
                <label htmlFor="forgot-email" className="font-semibold text-black">
                  Your email address
                </label>
                <input
                  id="forgot-email"
              ...
              <p className="text-center mt-5 text-[0.85rem] text-[#888]">
                ...
                <Link href="/host/login" className="text-[#ff6b9d] underline">
                  Back to login
                </Link>
              </p>
            </form>
