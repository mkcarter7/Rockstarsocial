        ...
        <div className="container">
          <div className="max-w-[1000px] mx-auto">
            <div className="mb-[60px]">
              <h2 className="text-[2.5rem] md:text-[2rem] mb-5 text-black">Who We Are</h2>
              <p className="text-[1.1rem] md:text-base text-[#4a5568] leading-[1.8] mb-5">
            ...
            <div className="mb-[60px]">
              <h2 className="text-[2.5rem] md:text-[2rem] mb-10 text-center text-black">What We Offer</h2>
            ...
            <div className="text-center py-[60px] px-5 bg-[#f7fafc] rounded-[10px]">
              <h2 className="text-[2.5rem] md:text-[2rem] mb-[15px] text-black">Ready to Get Started?</h2>
