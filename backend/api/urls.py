...
from .baby_shower_views import (
    ...
    delete_photo as bs_delete_photo,
...
from .wedding_views import (
    ...
    event_photos, delete_photo as wedding_delete_photo, event_guestbook, event_rsvp,
...
urlpatterns = [
    ...
    path('wedding/<slug:slug>/photos/<int:photo_id>/', wedding_delete_photo, name='wedding-delete-photo'),
    ...
    path('baby-shower/<slug:slug>/photos/<int:photo_id>/', bs_delete_photo, name='baby-shower-delete-photo'),
